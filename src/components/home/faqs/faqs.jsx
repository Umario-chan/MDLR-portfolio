...
const SkillsList = () => {
  ...
  const skills = {
    "¿Qué tecnologías uso?": [
      "Trabajo con tecnologías como React, Node.js, Astro, JavaScript, TypeScript, Cypress, Tailwind CSS, SASS, Figma, entre otras.",
    ],
    "Mi Experiencia": [
      "Tengo experiencia trabajando en startups, consultoras tecnológicas y empresas establecidas desarrollando y maquetando sitios web a partir de diseños en Figma. Para ello, utilizo tecnologías frontend como Astro y React, junto con Tailwind CSS y otras librerías y frameworks para el estilizado y la optimización de interfaces.",
    ],
    "Mi formacion": [
      "Estudié una ingenieria en sistemas computaciones en la UNIVDEP (Universidad del desarrollo empresarial y pedagógico), lo que me brindó las bases en programación. Posteriormente, decidí enfocarme en el desarrollo web y de software. Ademas, realicé diversos cursos y certificaciones, como el ISTQB Foundation level, tambien, complemento mi formación con el aprendizaje autodidacta, lo que me permite mantenerme actualizado con los avances tecnológicos en el desarrollo de software.",
    ],
    "¿Cómo trabajo en equipo?": [
      "Tengo experiencia trabajando en equipos multidisciplinarios, donde me he encargado del desarrollo frontend de aplicaciones web. Para ello, utilizo metodologías ágiles como Scrum y Kanban, además de herramientas de control de versiones como Git y GitHub para gestionar el flujo de trabajo. También cuento con experiencia en la aplicacion de pruebas y QA para asegurar la integridad de los desarrollos.",
    ],
    "Metodolgias Agiles": [
